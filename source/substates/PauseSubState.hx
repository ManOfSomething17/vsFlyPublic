...
class PauseSubState extends MusicBeatSubstate
{
	...
	public static var deathLabel:String = "Fails";

	public static function resetDeathLabel()
	{
		deathLabel = "Fails";
	}
	...
	override function create()
	{
		...
		if(metadata != null) levelInfo.text += ' - ${metadata.artist}';
		...
		var blueballedTxt:FlxText = new FlxText(20, 15 + 64, 0, deathLabel + ": " + PlayState.deathCounter, 32);
