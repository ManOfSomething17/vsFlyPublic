...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// Stage
		void = new FlxSprite(-300, -300).makeGraphic(FlxG.width * 2, FlxG.height * 2, FlxColor.WHITE);
		add(void);

		// Characters
		gf = new Character(400, 130, 'EX_GF');
		gf.x += gf.positionArray[0];
		gf.y += gf.positionArray[1];
		gf.scrollFactor.set(0.95, 0.95);
		boyfriend = new Character(770, 100, 'EX_BF', true);
