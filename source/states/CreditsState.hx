...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Vs Fly Team'],
			['Kyano',				'kyano',			'Director, Animator, Editor',						 'https://twitter.com/Kyan0o_',					 '00ffff'],
			['ManOfSomething',		'manofsomething',	'Composer, Charter, Programmer',					 'https://twitter.com/ManOfSomething1',				 'DD2D2D'],
			['MasterArt',			'masterart',		'Logo and Menu Artist',								 'https://twitter.com/MasterArtMA',			 '994B00'],
			[''],
			['Vs Fly Special Thanks'],
			['SPG64',				'spg64',			'Scripting Help',									 'https://twitter.com/SPG642',				'A94EBF'],
			[''],
			['Psych Engine Team'],
