...
class EditorPlayState extends MusicBeatSubstate
{
	...
	public function new(playbackRate:Float)
	{
		...
		judgeCounterTxt = new FlxText(20, scoreTxt.y - 104 , 0, "", 20);
		...
		if(ClientPrefs.data.downScroll) {
			judgeCounterTxt.y = scoreTxt.y + 36;
		}
		if(ClientPrefs.data.judgeCounter) add(judgeCounterTxt); //Dude idk how haxe works lmao 
	...
	function updateScore(miss:Bool = false)
	{
		...
		scoreTxt.text = 'Hits: $songHits | Breaks: $songMisses | Rating: $str';
	}
